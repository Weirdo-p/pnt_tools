...
testA_NSAT = sol["NGPS_2"][used_data] + sol["NGLO_2"][used_data] + sol["NBD2_2"][used_data] + sol["NBD3_2"][used_data] + sol["NGAL_2"][used_data] + sol["NQZS_2"][used_data]
...
# ax.set_xlim(0, 90)
plt.savefig("/home/xuzhuo/Documents/data/01-mini/20240717/proj/testA/ppt_plot/287000-287090_GVIO_GI.svg", transparent=True)
plt.show()
...
ax.tick_params(axis='both', which='major', labelsize=12)
ax.scatter(testA_time, testA_pdop, linewidths=1.5, color=color[1],s=10, marker="^")
ax.spines['left'].set_color([(238 / 255), (159 / 255), (0 / 255)])
...
ax.set_ylim(0, 20)
# ax.grid(linestyle='-', color='k', alpha=0.14)
...
ax.spines['top'].set_linewidth(1.5)
ax.set_xlim(0, 90)
plt.savefig("/home/xuzhuo/Documents/data/01-mini/20240717/proj/testA/ppt_plot/287000-287090_podp.svg", transparent=True)
plt.show()
