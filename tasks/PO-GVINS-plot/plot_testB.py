...
GVIO_PO_file = os.path.join(root, "288019-288250_GVIO_PO/ROVE_04.flf.imu_VIO.cmp")
GVIO_PO = np.loadtxt(GVIO_PO_file)
GI_TC_file = os.path.join(root, "288019-288250_TC/ROVE_04.flf.imu_VIO.cmp")
GI_TC = np.loadtxt(GI_TC_file)
MSCKF_GVIO_file = os.path.join(root, "288019-288250_m-GVIO/ROVE_04.flf.imu_VIO.cmp")
MSCKF_GVIO = np.loadtxt(MSCKF_GVIO_file)
PO_file = os.path.join(root, "288019-288250_PO/ROVE_04.flf.imu_VIO.cmp")
PO = np.loadtxt(PO_file)
MSCKF_file = os.path.join(root, "288019-288250_MSCKF/ROVE_04.flf.imu_VIO.cmp")
...
used_data = (sol['GPSTime'] >= 288019) & (sol['GPSTime'] < 288250)
testB_time = sol["GPSTime"][used_data]
testB_time = testB_time - testB_time[0]
testB_pdop = np.sqrt(np.linalg.norm(sol["HDOP"][used_data].reshape(-1, 1), axis=1, ord=2) + np.linalg.norm(sol["VDOP"][used_data].reshape(-1, 1), axis=1, ord=2))
testB_NSAT = sol["NSAT"][used_data]
...
for i_th, data in enumerate(all_data):
    for i in range(3):
        ...
        test = ax[i].plot(data[:, 0] - data[0, 0], (data[:, i + 1]) , ls="-", label=labels[i_th], linewidth=1, marker=markers[i_th], markersize=5, color=color[i_th], mec=[0,0,0], markeredgewidth=0.4)#, marker=marker[i], markersize=4)
        ax[i].set_xlim(0, 240)
        # ax[i].set_ylim(-4, 4)
        # ax[i].legend()
        ...
        ax[i].set_xticks([0, 40, 80, 120, 160, 200, 240])
        # ax[i].set_xticks()
...
ax[3].scatter(testB_time, testB_pdop, linewidths=1.5, color=color[1],s=10, marker="^")
...
ax = ax[3].twinx()
ax.scatter(testB_time, testB_NSAT, linewidths=1.5, color=color[0],s=10, marker="s")
ax.set_ylim(10, 40)
...
plt.savefig("/home/xuzhuo/Documents/data/01-mini/20240717/proj/288019-288250_GVIO_GI.svg", transparent=True)
plt.show()
...
plotCDF(CDF_plot, "/home/xuzhuo/Documents/data/01-mini/20240717/proj/testB_GNSSrelated_cdf.svg", color=color)
...
color = {3: [(0 / 255), (167 / 255), (251 / 255)],  # black
        ...
        4: [(20 / 255), (169 / 255), (89 / 255)],
        5: [(70 / 255), (114 / 255), (196 / 255)]}  # green
# plotCDF(CDF_plot, "/home/xuzhuo/Documents/data/01-mini/20240717/proj/testB_vis_only_cdf.svg", color=color)
...
root = "/home/xuzhuo/Documents/data/01-mini/20240717/proj"
GVIO_PO_file = os.path.join(root, "288019-288250_GVIO_PO/ROVE_04.flf")
GVIO_PO = getIPSPose(GVIO_PO_file, [288019, 288250])
GI_TC_file = os.path.join(root, "288019-288250_TC/ROVE_04.flf")
GI_TC = getIPSPose(GI_TC_file, [288019, 288250])
PO_file = os.path.join(root, "288019-288250_PO/ROVE_04.flf")
PO = getIPSPose(PO_file, [288019, 288250])
MSCKF_file = os.path.join(root, "288019-288250_MSCKF/ROVE_04.flf")
MSCKF = getIPSPose(MSCKF_file, [288019, 288250])
MSCKF_GVINS_file = os.path.join(root, "R_RTK_TCI/ROVE_04.flf")
MSCKF_GVIO = getIPSPose(MSCKF_GVINS_file, [288019, 288250])
...
write_tum(PO, "/home/xuzhuo/Documents/data/01-mini/20240717/proj/testB/PO.tum")
write_tum(MSCKF, "/home/xuzhuo/Documents/data/01-mini/20240717/proj/testB/MSCKF.tum")
write_tum(IE, "/home/xuzhuo/Documents/data/01-mini/20240717/proj/testB/IE.tum")
write_tum(GVIO_PO, "/home/xuzhuo/Documents/data/01-mini/20240717/proj/testB/GVIO_PO.tum")
write_tum(GI_TC, "/home/xuzhuo/Documents/data/01-mini/20240717/proj/testB/GI_TC.tum")
write_tum(MSCKF_GVIO, "/home/xuzhuo/Documents/data/01-mini/20240717/proj/testB/GVIO_MSCKF.tum")

items = ["MSCKF", "PO"]
dists = [1, 5, 10, 20, 40]
root = "/home/xuzhuo/Documents/data/01-mini/20240717/proj/testB"
...
plt.tight_layout()
plt.savefig("/home/xuzhuo/Documents/data/01-mini/20240717/proj/testB/testB_trans_rpe.svg", transparent=True)
