...
from utils.conversion.coordinate import BLH2XYZ, Attitude2Azimuth, Deg2Rad, XYZ2NEU
...
def CheckSINS():
    ...
    path = "/home/xuzhuo/Documents/data/gici/new/1.1/IPSProj/gnss_rover.flf"
...
def CheckGNSS():
    path = "/home/xuzhuo/Documents/data/gici/new/1.1/ground_truth.txt.nmea.transformed.translated.ie"
    head_gt, gt = ParseIESol().parseSINS(path)
    logger.info(gt)
    gt_tree = spatial.KDTree(np.array(gt["GPSTime"]).reshape(-1, 1))

    path = "/home/xuzhuo/Documents/data/gici/new/1.1/IPSProj/gnss_rover.ffp"
